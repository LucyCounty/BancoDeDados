...
class Locacao:
    def __init__(self, locacao:int=None, filme:filmes=None, usuario:Usuario=None, data_locacao:str=None, data_devolucao:str=None):
    ...
    def set_filme(self, filme:filmes):
        self.filme = filme
